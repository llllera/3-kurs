...
export_table_to_xml("personal_data")
export_table_to_xml("work_experience")
...
columns = {"id": "300", "fio": "Новая запись из XML", "registration": "2024-11-22"}
...
cur.execute('INSERT INTO persons (fio, registration) VALUES (?, ?)', (fio, registration))
con.commit()
cur.close()
con.close()
